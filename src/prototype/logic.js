...
class Component extends DCLogic {
  ...
  renderVals() {
    ...
    return {
      ...
      payHistory: [
        { ini: 'HA', bg: '#6E8BF5', ink: '#FF6B7A', badge: 'i', badgeBg: '#FFFFFF', badgeInk: '#0D1B2A', name: 'Hayder Aboshanna', dir: 'You sent', amt: '−600.000', date: '30 Aug', status: 'done' },
        { ini: 'MM', bg: '#F45D9B', ink: '#FF6B7A', badge: '▪', badgeBg: '#FFFFFF', badgeInk: '#E8453C', name: 'Mohammed Mahmood', dir: 'You sent', amt: '−198.000', date: '27 Aug', status: 'pending' },
        ...
        { ini: 'ZA', bg: '#2CC7C7', ink: '#FF6B7A', badge: '▪', badgeBg: '#FFFFFF', badgeInk: '#0D1B2A', name: 'Zainab Al Saadi', dir: 'You sent', amt: '−75.000', date: '11 Aug', status: 'done' },
        ...
        { ini: 'AH', bg: '#2CBFB0', ink: '#FF6B7A', badge: 'i', badgeBg: '#FFFFFF', badgeInk: '#0D1B2A', name: 'Ahmed Al Janahi', dir: 'You sent', amt: '−27.190', date: '4 Jul', status: 'done' },
        { ini: 'NK', bg: '#3BA5F0', ink: '#FF6B7A', badge: '▪', badgeBg: '#FFFFFF', badgeInk: '#0D1B2A', name: 'Noor Kadhim', dir: 'You sent', amt: '−36.720', date: '23 Jun', status: 'done' },
        { ini: 'YH', bg: '#3B9BF0', ink: '#FF6B7A', badge: 'i', badgeBg: '#FFFFFF', badgeInk: '#0D1B2A', name: 'Yousif Hassan', dir: 'You sent', amt: '−8.280', date: '6 Jun', status: 'done' },
        ...
        amtInk: h.amt.charAt(0) === '+' ? '#3FD39F' : '#FF6B7A',
      })),
      investBenefits: [
      ...
      homeTx: [
        { ini: 'CF', name: 'Ciao Cafe', sub: 'Today, 16:30 · Standard', amt: '−12.000', ink: '#FF6B7A', meta: 'Card', bg: '#2563EB' },
        { ini: 'IM', name: 'Iraq Mall', sub: 'Today, 15:48 · Pending', amt: '−64.000', ink: '#FF6B7A', meta: 'Card', bg: '#1B3FA8' },
        { ini: 'AS', name: 'Asiacell', sub: 'Today, 11:10 · Top-up', amt: '−25.000', ink: '#FF6B7A', meta: 'Mobile', bg: '#EC7E00' },
        ...
        { ini: 'MK', name: 'Al Rashid Market', sub: 'Yesterday, 18:22 · Work', amt: '−38.500', ink: '#FF6B7A', meta: 'Card', bg: '#00A78F' },
      ],
      homeUpcoming: [
